...
function PristupRezervaciji() {
 ...
 async function pristupi(
   ...
   const emailVrednost =
     email.trim()
   const sifraVrednost =
     sifra.trim().toUpperCase()
   if (
     !emailVrednost ||
     !sifraVrednost
   ) {
     setGreska(
       'Email i pristupna šifra su obavezni.',
     )
     return
   }
   if (
   ...
   try {
     ...
     if (error instanceof Error) {
       ...
       setGreska(
         'Rezervaciji trenutno nije moguće pristupiti.',
       )
     }
   } finally {
     setUcitavanje(false)
...
<p>
           Unesi email adresu i
           pristupnu šifru koju si
           dobio/la nakon uspešnog
...
<p className="pristup-opis">
             Za pristup su potrebna
             oba podatka.
</p>
<form
             className="pristup-forma"
             onSubmit={pristupi}
>
...
<section className="pristup-kartica">
<div className="pristup-uspeh-ikona">
             ✓
</div>
<p className="pristup-rezervaciji-nadnaslov">
             Pristup uspešan
...
<div className="pristup-task43-napomena">
<strong>
               Upravljanje rezervacijom
</strong>
<p>
               Dodavanje i uklanjanje
               usluga i otkazivanje
               rezervacije biće
               dostupni na ekranu za
               upravljanje rezervacijom.
</p>
</div>
<button
